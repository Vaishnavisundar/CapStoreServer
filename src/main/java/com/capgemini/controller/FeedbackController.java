...
public class FeedbackController {
	...
	// to get the comments for the merchant in the merchant page
	// enter the product id to get the required feedback for that merchant regarding the product
	@RequestMapping(value = "/merchantcomments")
